...
const pg = document.getElementById('para').innerHTML;
const pg2 = document.getElementById('para1').innerHTML;
// const pg3 = document.getElementsByClassName('p1').innerHTML;

function rep(){
    // document.getElementById('para1').innerHTML = pg;
